...
public class ChatterEntity : PunBehaviour
{
    ...
    {
        photonView.RPC("RpcShowChat", PhotonTargets.AllViaServer, message);
    }
    ...
    {
        photonView.RPC("RpcShowEmoticon", PhotonTargets.AllViaServer, id);
    }
